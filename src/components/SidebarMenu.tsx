      ...
      >
        ...
        >
          <nav className='space-y-2 w-full relative z-30 '>
            <button
              className='w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-white/20 text-white font-medium transition-colors hover:bg-white/30'
              aria-current='page'
            >
            ...
            <button className='w-full flex items-center gap-3 px-4 py-3 rounded-xl text-white font-medium transition-colors hover:bg-white/10'>
